...
#for showing signup/login button for admin(by Utkarsh)
...
#for showing signup/login button for doctor(by Utkarsh)
...
#for showing signup/login button for patient(by Utkarsh)
...
#-----------for checking user is doctor , patient or admin(by Utkarsh)
def is_admin(user):
